...
public class Pessoa_fisica extends Cliente {
    ...
    private String cpf, nm_cliente, sexo, estado_civil, dt_nascimento;
    ...
    public Pessoa_fisica(int id_cliente, int id_endereco, String telefone01, String telefone02, String tp_cliente, String email, String ind_cliente_novo, String senha, String cpf, String nm_cliente, String sexo, String estado_civil, String dt_nascimento) {
        super(id_cliente, id_endereco, telefone01, telefone02, tp_cliente, email, ind_cliente_novo, senha);
        this.cpf = cpf;
        this.nm_cliente = nm_cliente;
        this.sexo = sexo;
        this.estado_civil = estado_civil;
